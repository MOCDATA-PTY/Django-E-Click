# Generated by Django 5.1.7 on 2025-11-14 06:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not_started', 'Not Started'), ('in_progress', 'In Progress'), ('in_progress_guidance_required', 'In Progress (Guidance Required)'), ('completed', 'Completed'), ('completed_review_pending', 'Completed (Review Pending)'), ('completed_data_discrepancy_addressing', 'Completed (Data Discrepancy addressing)')], default='not_started', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('planned', 'Planned'), ('in_progress', 'In Progress'), ('in_progress_guidance_required', 'In Progress (Guidance Required)'), ('completed', 'Completed'), ('completed_review_pending', 'Completed (Review Pending)'), ('completed_data_discrepancy_addressing', 'Completed (Data Discrepancy addressing)')], default='planned', max_length=50)),
                ...
                ('clients', models.ManyToManyField(blank=True, help_text='Clients/investors associated with this project', related_name='projects', to='home.client')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True)),
                ('status', models.CharField(choices=[('not_started', 'Not Started'), ('in_progress', 'In Progress'), ('in_progress_guidance_required', 'In Progress (Guidance Required)'), ('completed', 'Completed'), ('completed_review_pending', 'Completed (Review Pending)'), ('completed_data_discrepancy_addressing', 'Completed (Data Discrepancy addressing)'), ('on_hold', 'On Hold'), ('cancelled', 'Cancelled')], default='not_started', max_length=50)),
